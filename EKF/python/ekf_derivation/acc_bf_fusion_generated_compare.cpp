...
int main()
{
    ...
    // Compare X axis equations
    {
        ...
        drag_innov_var = (-HK13*HK21*HK24 + HK14*HK21*HK29 + HK15*HK18*HK21 - HK16*HK21*HK30 + HK17*HK21*HK31 - HK20*HK22 + HK22*HK23 + HK26*HK27 - HK27*HK28 + R_ACC);
        HK32 = Kaccx / drag_innov_var;
        ...
        Hfusion[22] = HK8;		// state index 22
        Hfusion[23] = HK10;		// state index 23
        ...
        for (int row=0; row<24; row++) {
            float diff_fraction;
            if (H_ACC(row) != 0.0f) {
                diff_fraction = fabsf(Hfusion_sympy[row] - H_ACC(row)) / fabsf(H_ACC(row));
    ...
    // Compare Y axis equations
    {
        ...
        float HK32;
        drag_innov_var = (HK12*HK19*HK20 + HK14*HK19*HK29 + HK15*HK18*HK19 + HK16*HK19*HK30 - HK17*HK19*HK31 + HK22*HK23 - HK23*HK24 + HK26*HK27 - HK27*HK28 + R_ACC);
        HK32 = Kaccy / drag_innov_var;
